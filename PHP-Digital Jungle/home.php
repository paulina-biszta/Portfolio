...
$resProd = mysqli_query($conn, "SELECT * FROM products");
...
<section>
  ...
  <div class="grid-container">
            ...
            <img src="https://images.unsplash.com/photo-1532795986-dbef1643a596?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=600&q=60">
                <h1><a href="./sale.php">SUMMER SALE</a></h1>
            </div>
